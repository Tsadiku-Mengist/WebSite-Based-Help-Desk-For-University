        ...
        <div class=" grid lg:grid-cols-3 mt-10 "   >
          ...
          <div class="pt-10 pl-5 pb-3" > 
              <ul class="bg-gray-100  rounded w-58 divide-y divide-gray-700 divide-opacity-25 text-gray-800">
                   ...
                   <li >headName :<span class="font-bold"> {{agriculcherCollege.headName}}</span> </li>
                   ...
                   <!--Icon-->
             <div class="pl-5">
               <div><router-link :to="`/SeeMoreAgri_table_List${agriculcherCollege.id}`" > <span style="font-size: 1.5em; color:blue "> <fa icon="eye" />More...</span> </router-link></div> 
             </div>
             </div>
