<template>
    ...
    <div class="bg-green-600">
      ...
      <div class="pt-5 pl-80">
         <div class="pl-80">
        <router-link to="/ContactOther/add" class="font-serif  text-center   font-poppins outline outline-offset-4  hover:bg-green-900 m-5 cursor-pointer px-5 py-1 rounded-full bg-green-500"><span style="font-size: 1em; color:white  "> <fa icon="plus" /></span>Add New</router-link>
       ...
       <div class=" grid lg:grid-cols-3 mt-10 "   >
         ...
         <div class="pt-10 pl-5 pb-3" > 
            ...
            <div class="pt-10 pl-5">
              ...
              <div><router-link :to="`/ContactOther/edit${other.id}`"><span style="font-size: 1.5em; color:blue "> <fa icon="edit" /></span></router-link></div>
              <div><button @click="clickDeleteOther(other.id)"><span style="font-size: 1.5em; color:red "> <fa icon="trash" /></span> </button></div>
            </div>
          </div>
       </div>
